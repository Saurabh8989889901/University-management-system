...
public class UpdateTeacher extends JFrame implements ActionListener {
    ...
    JTextField tfcourse, tfaddress, tfempid, tfphone, tfemail, tfbranch;
    JLabel labelrollno;
    Choice cEmpId;
    ...
    UpdateTeacher() {
        ...
        lblrollno.setBounds(50, 100, 200, 25);
        ...
        labelrollno = new JLabel("Employee Id");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                String query = "UPDATE teacher SET Emp_Id='" + EmpId + "', Address='" + Address + "', Phone='" + Phone
                        + "', Email='" + Email + "', Qualification='" + Qualification + "', Department='" + Department
                        + "' WHERE Emp_Id='" + EmpId + "'";
